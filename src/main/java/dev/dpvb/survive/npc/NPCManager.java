...
import dev.dpvb.survive.npc.upgrader.UpgradeCost;
...
public class NPCManager {
     ...
     * Should only be calling this in {@link Survive#onEnable()}
     */
    public void loadNPCs() {
        // Load Enchantment Configuration for Enchantment NPCs
        ConfigurationSection enchConfig = Survive.Configuration.getEnchantingSection();
        ...
        upgrades = loadUpgrades(Survive.Configuration.getUpgradingSection());

        // Load TokenTrader Configuration for TokenTrader NPCs
        tokenTraderItems = loadTokenTraderItems(Survive.Configuration.getTokenTraderSection());
